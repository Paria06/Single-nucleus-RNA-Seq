...
outDir <- "/home/paria/scratch/als-project/analysis/ocu_med_sc/rpca/pseudo_bulk_DEG/als_vs_con_each_region/DEG_ALS_vs_con_sc/cluster"
...
dds$region <- relevel(dds$region, ref = "sc")
