...
print("DEG_sl_cluster")
# all the results, table, figuures of this analysis are saved in the below directory
outDir <- "/home/paria/scratch/als-project/analysis/ocu_med_sc/rpca/pseudo_bulk_DEG/als_vs_con_each_region/DEG_ALS_vs_con_sl/cluster"
...
dds$region <- relevel(dds$region, ref = "sl")
