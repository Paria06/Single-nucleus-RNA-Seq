...
reference <- readRDS("/home/paria/scratch/als-project/analysis/OCU_MED/ocu-med3/singleR/reference/IO.rds")
...
# Generate heatmap
pdf('pheatmap_IO_supercluster.pdf', height = 30, width = 30)
...
# Create UMAP plot
pdf("DimPlot_IO_supercluster.pdf", height = 20, width = 40)
